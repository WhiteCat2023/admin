...
import { collection, onSnapshot, addDoc, updateDoc, deleteDoc, doc, getDoc, setDoc, increment, serverTimestamp } from 'firebase/firestore'
import { Box, Typography, Button, Modal, TextField, Card, CardContent, Grid, IconButton, Avatar, Container, Paper, InputAdornment, Chip, Stack, Fade, Menu, MenuItem } from '@mui/material'
            ...
            >
              ...
              <Button
                ...
                sx={{
                  borderRadius: "8px",
                  backgroundColor:
                    filter === "newest" ? "#2ED573" : "transparent",
                              ...
                              >
                                ...
                                {/* {user?.uid === discussion.authorId && (
                                  <Box>
                                    ...
                                    <Menu
                                      anchorEl={anchorEl}
                                      open={Boolean(anchorEl) && selectedPostId === discussion.id}
                                      onClose={handleMenuClose}
